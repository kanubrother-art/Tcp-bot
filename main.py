            ...
            while True:
                ...
                if data_hex.startswith("0500") and insquad is None and joining_team == False:
                    try:
                        ...
                        insquad = True
                        try:
                            welcome_message = """[B][C][FFFFFF]Welcome to SPIDY Bot
...
async def MaiiiinE():
    ...
    Uid, Pw = '4317245813', '5D56174CEA953365B5142040C9EDE6A123F010BA6D4C945B0B4576E54BED0D97'
    ...
    os.system('clear')
    print(render('SPIDY', colors=['white', 'green'], align='center'))
    print('')
    print("🤖 SPIDY BOT - ONLINE")
    print("=" * 50)
    print(f"🔹 UID: {TarGeT}")
